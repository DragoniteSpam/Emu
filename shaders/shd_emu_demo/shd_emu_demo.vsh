...
void main() {
    ...
    if (u_lightEnabled == 1.0) {
        vertexColor = vec4(0.25, 0.25, 0.25, 1);
        CommonPointLightEvaluate(vertexColor, worldPosition, worldNormal, vec3(48, 0, 32), 200.0);
        CommonPointLightEvaluate(vertexColor, worldPosition, worldNormal, vec3(-16, -32, 80), 96.0);
    }
