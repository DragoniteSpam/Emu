function VButtonImage(_x, _y, _w, _h, _sprite, _index, _blend, _alpha, _scale_to_fit, _callback) : VCallback(_x, _y, _w, _h, 0, _callback) constructor {
    sprite = _sprite;
    index = _index;
    blend = _blend;
    alpha = _alpha;
    ...
    Render = function(base_x, base_y) {
        ...
        var sprite_image = exists ? sprite : spr_vanadium_not_found;
        ...
        DrawNineslice(1, 0, 0, width, height, VANADIUM_COLOR_BACK, 1);
